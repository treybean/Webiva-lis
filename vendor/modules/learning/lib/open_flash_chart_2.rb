  ...
  def ofc2_inline(width, height, graph, base='/', id=Time.now.usec)
    ...
    <<-EOF
      ...
      <script type="text/javascript">
        ...
        swfobject.embedSWF(
          '/components/learning/open-flash-chart.swf', '#{div_name}',
  ...
  def ofc2(width, height, url, base='/', id =Time.now.usec)
    ...
    <<-EOF
      ...
      <script type="text/javascript">
          ...
          var so = new SWFObject("/components/learning/open-flash-chart.swf",'mpl','#{width}','#{height}','7');
